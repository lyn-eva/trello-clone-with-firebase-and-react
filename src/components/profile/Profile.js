...
function Profile() {
  const { createProfile, getDocuments, key } = useDB();
    ...
    <div className="p-2 bg-[#0079bf] h-screen">
      ...
      <main className="mt-8 text-white">
        ...
        <ul className="grid grid-rows-3 grid-cols-4 gap-4">
          ...
          <li>
            <Button className="bg-green-300 h-40 w-full rounded-md p-3 text-3xl bg-hover-clr shadow-inner shadow-grey-500"><i className='fas fa-plus'/> New</Button>
          </li>
        </ul>
      </main>
    </div>
